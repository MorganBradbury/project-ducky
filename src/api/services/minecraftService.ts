 ...
 */
export const minecraftActivePlayers = async (): Promise<string[] | null> => {
  ...
  try {
    ...
    return serverInfo?.players.online || null; // Return the player count or null if it's unavailable
  } catch (error) {
