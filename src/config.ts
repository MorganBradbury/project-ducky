...
export const config = {
  ...
  VC_GAMES_CATEGORY_ID: loadEnvVar("VC_GAMES_CATEGORY_ID"),
  VC_MINECRAFT_FEED_CATEGORY_ID: loadEnvVar("VC_MINECRAFT_FEED_CATEGORY_ID"),
  MINECRAFT_SERVER_IP: loadEnvVar("MINECRAFT_SERVER_IP"),
  MINECRAFT_SERVER_PORT: loadEnvVar("MINECRAFT_SERVER_PORT"),
  OPENAI_API_KEY: loadEnvVar("OPENAI_API_KEY"),
